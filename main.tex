...
\newcommand{\thesistitle}{Machine Learning to go nyoom} % Your thesis title, this is used in the title and abstract
...
\newcommand{\typeofthesis}{report} % dissertation, Final Year Project, report, etc.
...
\newcommand{\supervisor}{Assistant Prof. Lucy Hederman} % replace with the name of your supervisor
